...
function SampleEntry({ stampDate }: { stampDate: string }) {
  return (
    <article
...
export default async function Home() {
  ...
  const stampDate = new Intl.DateTimeFormat(locale, { day: "2-digit", month: "short" }).format(new Date());
  ...
  return (
    <main className="paper-grid flex-1 overflow-x-hidden px-6 pb-24 pt-16">
      <div className="mx-auto flex w-full max-w-md flex-col items-center gap-12">
        ...
        <SampleEntry stampDate={stampDate} />
